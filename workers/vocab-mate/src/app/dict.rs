...
use crate::app::{fauna::FaunaDbClient, rapidapi::WordsApiClient, vocab::*};
use crate::utils::log;
...
impl Dict for DictImpl {
    async fn async_lookup(&self, vocab: String) -> Result<Vec<Vocab>> {
        ...
        log::debug(&format!("stored={:?}", stored));
